...
# \DONE
lists=lists
w=work #cambia numero
name_exp=one #si ponemos two tendremos resultadso para 2 y asi...
db=spk_8mu/speecon
...
# \DONE Hemos creado las features mfcc y lpcc
compute_lp() {
...
for cmd in $*; do
   ...
   if [[ $cmd == train ]]; then
       ...
       # \DONE Hemos modificado los parámetros para el gmm_train
